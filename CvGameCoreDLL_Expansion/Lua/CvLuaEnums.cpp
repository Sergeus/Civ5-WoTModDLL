...
//	RegisterEnum(NOTIFICATION_POLICY_ADOPTION);
	...
	RegisterEnum(NOTIFICATION_RELIGION_FOUNDED_ACTIVE_PLAYER);
	RegisterEnum(NOTIFICATION_RELIGION_FOUNDED);
	RegisterEnum(NOTIFICATION_PANTHEON_FOUNDED_ACTIVE_PLAYER);
	RegisterEnum(NOTIFICATION_PANTHEON_FOUNDED);
	RegisterEnum(NOTIFICATION_FOUND_PANTHEON);
	RegisterEnum(NOTIFICATION_FOUND_RELIGION);
	RegisterEnum(NOTIFICATION_ENHANCE_RELIGION);
	RegisterEnum(NOTIFICATION_RELIGION_ENHANCED_ACTIVE_PLAYER);
	RegisterEnum(NOTIFICATION_RELIGION_ENHANCED);
	RegisterEnum(NOTIFICATION_SPY_CREATED_ACTIVE_PLAYER);
	RegisterEnum(NOTIFICATION_SPY_STOLE_TECH);
	RegisterEnum(NOTIFICATION_SPY_CANT_STEAL_TECH);
	RegisterEnum(NOTIFICATION_CAN_BUILD_MISSIONARY);
	RegisterEnum(NOTIFICATION_OTHER_PLAYER_NEW_ERA);
	RegisterEnum(NOTIFICATION_SPY_EVICTED);
	RegisterEnum(NOTIFICATION_RELIGION_SPREAD);
	RegisterEnum(NOTIFICATION_TECH_STOLEN_SPY_DETECTED);
	RegisterEnum(NOTIFICATION_TECH_STOLEN_SPY_IDENTIFIED);
	RegisterEnum(NOTIFICATION_SPY_WAS_KILLED);
	RegisterEnum(NOTIFICATION_SPY_KILLED_A_SPY);
	RegisterEnum(NOTIFICATION_SPY_REPLACEMENT);
	RegisterEnum(NOTIFICATION_MAYA_LONG_COUNT);
	RegisterEnum(NOTIFICATION_FAITH_GREAT_PERSON);
	RegisterEnum(NOTIFICATION_SPY_PROMOTION);
	RegisterEnum(NOTIFICATION_INTRIGUE_DECEPTION);
	RegisterEnum(NOTIFICATION_SPY_RIG_ELECTION_SUCCESS);
	RegisterEnum(NOTIFICATION_SPY_RIG_ELECTION_FAILURE);
	RegisterEnum(NOTIFICATION_SPY_RIG_ELECTION_ALERT);
	RegisterEnum(NOTIFICATION_SPY_YOU_STAGE_COUP_SUCCESS);
	RegisterEnum(NOTIFICATION_SPY_YOU_STAGE_COUP_FAILURE);
	RegisterEnum(NOTIFICATION_SPY_STAGE_COUP_SUCCESS);
	RegisterEnum(NOTIFICATION_SPY_STAGE_COUP_FAILURE);
	RegisterEnum(NOTIFICATION_INTRIGUE_BUILDING_SNEAK_ATTACK_ARMY);
	RegisterEnum(NOTIFICATION_INTRIGUE_BUILDING_SNEAK_ATTACK_AMPHIBIOUS);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_KNOWN_CITY_UNKNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_KNOWN_CITY_KNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_YOU_CITY_UNKNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_YOU_CITY_KNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_ARMY_AGAINST_UNKNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_KNOWN_CITY_UNKNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_KNOWN_CITY_KNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_YOU_CITY_UNKNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_YOU_CITY_KNOWN);
	RegisterEnum(NOTIFICATION_INTRIGUE_SNEAK_ATTACK_AMPHIB_AGAINST_UNKNOWN);
	RegisterEnum(NOTIFICATION_RELIGION_ERROR);
	RegisterEnum(NOTIFICATION_AUTOMATIC_FAITH_PURCHASE_STOPPED);
	RegisterEnum(NOTIFICATION_EXPANSION_PROMISE_EXPIRED);
	RegisterEnum(NOTIFICATION_BORDER_PROMISE_EXPIRED);
	RegisterEnum(NOTIFICATION_TRADE_ROUTE);
	RegisterEnum(NOTIFICATION_TRADE_ROUTE_BROKEN);
	RegisterEnum(NOTIFICATION_RELIGION_SPREAD_NATURAL);
	RegisterEnum(NOTIFICATION_INTRIGUE_CONSTRUCTING_WONDER);
	RegisterEnum(NOTIFICATION_MINOR_BUYOUT);
